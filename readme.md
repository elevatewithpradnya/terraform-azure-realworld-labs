...
✅ What actually breaks (and saves) production

---

## 🎯 Who This Repository Is For
- Cloud / DevOps engineers preparing for **Terraform & Azure interviews**
- Engineers working with **existing (brownfield) infrastructure**
- Anyone who wants to understand **WHY** things are done, not just HOW
...
- Read the README of each lab carefully
- Run `terraform plan` before every `apply`
- Focus on **why**, not just commands

---

## ⭐ If You Find This Repository Helpful
- ⭐ **Star the repo** to save it
- 👤 **Follow me on GitHub** for more real-world labs
- 🔔 **Watch the repo** to get updates as new labs are added

> This repo focuses on **what real teams do in production** —
> the part most tutorials skip.

---

## 🤝 Connect
- **LinkedIn:** https://www.linkedin.com/in/learnwithpradnya  
